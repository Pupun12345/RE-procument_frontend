...
function LoginPage() {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$authStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])((s)=>s.login);
    ...
    async function handleSendOtp(e) {
        ...
        setLoading(true);
        try {
            const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendOtp"])(phone);
    ...
    async function handleVerifyOtp(e) {
        ...
        setLoading(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["verifyOtp"])(sessionInfo, otp.trim());
            if (data.idToken) {
                login();
...
//# sourceMappingURL=src_585c6cee._.js.map