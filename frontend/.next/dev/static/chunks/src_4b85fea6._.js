...
async function sendOtp(phone) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        window.dispatchEvent(new CustomEvent("demo-otp", {
            detail: DEMO_OTP
        }));
    }
    return "demo-session";
...
function LoginPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            ...
            return ({
                "LoginPage.useEffect": ()=>window.removeEventListener("demo-otp", handleOtpEvent)
            })["LoginPage.useEffect"];
        }
    }["LoginPage.useEffect"], []);
    // ---------------------------------------------------
    async function handleSendOtp(e) {
        ...
        setLoading(true);
        try {
            const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendOtp"])(phone);
    ...
    async function handleVerifyOtp(e) {
        ...
        setLoading(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyOtp"])(sessionInfo, otp.trim());
            if (data.idToken) {
                login();
...
_s(LoginPage, "M4QrcZsr+956qnmmxcjTNTTKKzw=", false, function() {
    return [
...
//# sourceMappingURL=src_4b85fea6._.js.map