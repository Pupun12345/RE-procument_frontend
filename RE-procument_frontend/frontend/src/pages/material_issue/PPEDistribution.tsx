...
const DistributionPage: React.FC = () => {
      // Material row type for dynamic materials
      interface MaterialRow {
        material: string;
        quantity: string;
        unit: string;
      }
      // Dynamic materials state (like ScaffoldingOrder)
  ...
  // ====================== FETCH DATA ======================
  // No API: useEffect and fetch functions removed
            ...
            {/* Materials Section */}
              ...
              <div className="ppe-buttons" style={{ marginTop: "18px" }}>
                  <button
                    ...
                    onClick={() => {
                      // Add each material as a new record
