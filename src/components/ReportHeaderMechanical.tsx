...
export default function ReportHeader() {
  ...
  const MechanicalReport = async () => {
    try {
      const response = await api.get("/reports/mechanical");
  ...
  const exportPDF = () => {
    ...
    const addHeader = () => {
      ...
      doc.setFontSize(16);
      doc.setFont("helvetica", "bold");
      doc.text("MECHANICAL FINAL REPORT", pageWidth / 2, 55, {
        align: "center",
      });
    };
  ...
  return (
    <div className="report-header">
      <div>
        ...
        <p>
          Consolidated overview of Mechanical Equipment inventory and
          distribution.
        </p>
      </div>
