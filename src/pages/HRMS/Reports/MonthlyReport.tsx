    ...
    <div className="yearly-report-container">
        ...
        <div className="header-left">
          ...
          <div className="header-content">
            <div className="breadcrumb">
              ...
              <span className="breadcrumb-item active">Monthly Report</span>
            </div>
            <h1 className="report-title">Monthly Data Report</h1>
            <p className="report-subtitle">
              A comprehensive monthly payroll summary and financial trends for the fiscal year.
            </p>
          </div>
        </div>
      ...
      <div className="chart-section">
        <div className="chart-header">
          <h2 className="chart-title">Monthly Salary Trends</h2>
      ...
      <div className="table-section">
        ...
        <div className="table-footer">
          <span className="viewing-text">
            Viewing {monthlyData.length} of 12 months
          </span>
        </div>
      </div>
    </div>
