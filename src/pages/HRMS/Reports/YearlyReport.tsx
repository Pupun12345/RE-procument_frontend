...
export function YearlyReport() {
  ...
  return (
    <div className="yearly-report-container">
        ...
        <div className="header-left">
          ...
          <div className="header-content">
            <div className="breadcrumb">
              ...
              <span className="breadcrumb-item active">Yearly Report</span>
            </div>
            <h1 className="report-title">Yearly Data Report</h1>
            <p className="report-subtitle">
              A comprehensive yearly payroll summary and financial trends for the fiscal year.
            </p>
          </div>
        </div>
      ...
      {/* Detailed Yearly Summary Table */}
      <div className="table-section">
        <div className="table-header">
          <div className="table-title-group">
            <h2 className="table-title">Yearly Summary</h2>
          </div>
        ...
        <div className="table-footer">
          <span className="viewing-text">
            Viewing yearly summary for {fiscalYear}
          </span>
        </div>
      </div>
    </div>
