...
const PPEStockReport: React.FC = () => {
  ...
  useEffect(() => {
    const fetchStocks = async () => {
      try {
        ...
        console.error("Failed to fetch PPE stock", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  const exportCSV = () => {
    ...
    link.download = "ppe_stock_report.csv";
    link.click();
  };
  ...
  const exportPDF = () => {
    ...
    const addHeader = () => {
      ...
      doc.setFontSize(16);
      doc.text("PPE STOCK REPORT", pageWidth / 2, 55, { align: "center" });
    };
    ...
    doc.save("ppe_stock_report.pdf");
  };

  return (
    <div className={styles.page}>
      <h2 className={styles.title}>PPE STOCK OVERVIEW</h2>
      ...
      <div className={styles.tableCard}>
        {loading ? (
          <p className={styles.loading}>Loading PPE stock...</p>
        ) : (
