...
const OldRegistrationStockReport: React.FC = () => {
  ...
  useEffect(() => {
    const fetchStocks = async () => {
      try {
        ...
        console.error("Failed to fetch old registration stock", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  const exportCSV = () => {
    ...
    link.download = "old_registration_stock_report.csv";
    link.click();
  };
  ...
  const exportPDF = () => {
    ...
    doc.save("old_registration_stock_report.pdf");
  };
...
export default OldRegistrationStockReport;
