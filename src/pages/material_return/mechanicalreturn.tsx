...
const DistributionPage: React.FC = () => {
  ...
  const handleDelete = async (id: string) => {
    if (!window.confirm("Delete this Mechanical return?")) return;

    try {
      await api.delete(`/returns/mechanical/${id}`);
      toast("success");
      fetchRecords();
    } catch {
      toast("error");
  ...
  const updateDistribution = async () => {
    ...
    try {
      ...
      await api.put(`/returns/mechanical/${editRecord._id}`, payload);
  ...
  return (
    <div className="ppe-container">
      <div className="ppe-content">
        <h2 className="ppe-title">MECHANICAL RETURN</h2>
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      await api.post("/returns/mechanical", payload);
