...
const DistributionPage: React.FC = () => {
  ...
  const exportPDF = (): void => {
    ...
    const addHeader = () => {
      ...
      doc.setFontSize(16);
      doc.setFont("helvetica", "bold");
      doc.text("MECHANICAL ISSUE REPORT", pageWidth / 2, 55, { align: "center" });
    };
    ...
    Object.entries(grouped).forEach(([supervisor, recs]) => {
      ...
      supervisorTotals.push({ name: supervisor, totalIssuedWeight: supervisorWeight });
    });
    ...
    autoTable(doc, {
      ...
      head: [["Issued To", "Item", "Qty", "Unit", "Date", "Location"]],
      body: tableBody,
      ...
      didParseCell: (data: any) => {
        // Merge supervisor cell vertically by making it blank for repeated rows
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      await api.post("/issue/mechanical", payload);
        ...
        {activeTab === "report" && (
          <React.Fragment>
            ...
            <div
              ...
              style={{ margin: "0 auto", maxWidth: 1100 }}
            >
              <table className="ppe-table">
                <thead>
                  <tr>
                    ...
                    <th style={{ color: "black" }}>Issued To</th>
                          ...
                          {r.items.map((i, n) => (
                            <div
                              ...
                              style={{
                                ...
                                gap: "12px",
                                marginBottom: n === r.items.length - 1 ? 0 : "14px",
                              }}
                            >
                              <span
                                style={{
