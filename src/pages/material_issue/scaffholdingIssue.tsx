...
export default function ScaffholdingIssuePage() {
  ...
  const [materials, setMaterials] = useState<MaterialRow[]>([
    { itemName: '', unit: '', unitWeight: '', issuedQuantity: '', issuedWeight: '' }
  ]);
  ...
  const addMaterial = () => {
    setMaterials([...materials, { itemName: '', unit: '', unitWeight: '', issuedQuantity: '', issuedWeight: '' }]);
            ...
            <div className="ppe-form-card" style={{ margin: "0 auto", maxWidth: 900 }}>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <div className="ppe-material-table">
                  <div className="ppe-table-head" style={{ display: 'grid', gridTemplateColumns: '48px 2fr 1fr 1fr 1fr 1fr 1fr', alignItems: 'center' }}>
                    <span>#</span>
                    <span>Item Name</span>
                    <span>Unit</span>
                  ...
                  {materials.map((row, index) => (
                    <div className="ppe-table-row" key={index} style={{ display: 'grid', gridTemplateColumns: '48px 2fr 1fr 1fr 1fr 1fr 1fr', alignItems: 'center' }}>
                      <span>{index + 1}</span>
                      <input
                        className="ppe-input"
                        value={row.itemName}
                      ...
                      <input
                        ...
                        onChange={e => updateMaterial(index, 'issuedWeight', e.target.value)}
              ...
              <div className="ppe-buttons" style={{ marginTop: "18px" }}>
                <button
                  ...
                  onClick={() => {
                    ...
                    setMaterials([{ itemName: '', unit: '', unitWeight: '', issuedQuantity: '', issuedWeight: '' }]);
                    setForm({
                      itemName: '',
                      quantity: '',
                      unit: '',
